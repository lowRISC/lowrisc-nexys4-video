...
set_property verilog_define [list FPGA FPGA_FULL NEXYS4_VIDEO ETH_DEBUG] [get_filesets sources_1]
...
#set_property verilog_define [list FPGA FPGA_FULL NEXYS4_VIDEO ETH_DEBUG]] $obj
